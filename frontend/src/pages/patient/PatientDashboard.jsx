...
const PatientDashboard = () => {
    ...
    useEffect(() => {
        ...
        const storedStreak = JSON.parse(localStorage.getItem('userStreak')) || { count: 0, lastCheckIn: null };
        ...
        <div className="min-h-screen bg-slate-50 font-sans text-slate-900 pb-20 relative overflow-x-hidden">
            ...
            <nav className="sticky top-0 z-40 bg-white/80 backdrop-blur-md border-b border-slate-200 shadow-sm">
                <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-xl font-black text-slate-800 tracking-tight">AyurCare</span>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        >
                            ...
                            <span className="font-bold text-orange-700">{streakData.count} Days</span>
                        </button>
                ...
                <div className="max-w-7xl mx-auto relative z-10 flex flex-col md:flex-row justify-between items-end gap-8">
                    <div className="animate-slide-up">
                        ...
                        <h1 className="text-5xl md:text-6xl font-black text-white mb-4 leading-tight tracking-tight drop-shadow-xl">
                            Hi, {user?.name.split(' ')[0]} <span className="text-4xl">👋</span>
                        </h1>
                    ...
                    <div className="flex gap-4 animate-slide-up" style={{ animationDelay: '100ms' }}>
                        <Link to="/patient/log-intake" className="group relative px-8 py-4 bg-white text-indigo-900 rounded-2xl font-bold shadow-xl overflow-hidden transition-transform hover:-translate-y-1">
                            ...
                            <span className="relative flex items-center gap-2 text-lg"><span>🍽️</span> Log Meal</span>
                        </Link>
                        <Link to="/patient/book-appointment" className="px-8 py-4 bg-indigo-600/50 backdrop-blur-md border border-indigo-400/50 text-white rounded-2xl font-bold hover:bg-indigo-600/70 transition-all hover:-translate-y-1 shadow-lg">
            ...
            <div className="max-w-7xl mx-auto px-6 -mt-24 grid grid-cols-1 lg:grid-cols-12 gap-8 relative z-20">
                ...
                <div className="lg:col-span-8 space-y-8">
                    ...
                    {/* TODAY'S MENU CARD */}
                    <section className="bg-white/90 backdrop-blur-xl rounded-[2.5rem] p-8 shadow-xl border border-white/50 animate-slide-up" style={{ animationDelay: '200ms' }}>
                        <div className="flex justify-between items-center mb-8">
                            <div>
                                <h2 className="text-2xl font-black text-slate-800">Today's Menu</h2>
                                <p className="text-slate-500 font-medium">Your personalized fuel plan.</p>
                            </div>
                                    ...
                                    <div key={plan._id}>
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                            {plan.meals.map((meal, idx) => (
                                                <div key={idx} className="relative bg-gradient-to-br from-white to-slate-50 border border-slate-100 p-6 rounded-[2rem] hover:shadow-lg hover:shadow-indigo-500/10 hover:border-indigo-100 transition-all duration-300 hover:-translate-y-1">
                                                    <div className="flex items-center gap-3 mb-4 pb-3 border-b border-slate-100">
                                                        ...
                                                        <h4 className="font-bold text-sm uppercase text-slate-500 tracking-widest">{meal.mealType}</h4>
                                                    </div>
                                                    <ul className="space-y-3">
                                                        {meal.items.map((item, i) => (
                                                            <li key={i} className="flex justify-between items-center text-sm">
                                                                <span className="font-bold text-slate-700">{item.foodItem?.name || 'Item'}</span>
                    ...
                    {/* NUTRITION CHART */}
                    <section className="bg-white rounded-[2.5rem] p-8 shadow-lg border border-slate-100 animate-slide-up" style={{ animationDelay: '300ms' }}>
                        <div className="flex justify-between items-center mb-6">
                            <div className="flex items-center gap-3">
                                ...
                                <h2 className="text-xl font-black text-slate-800">Nutrition Trends</h2>
                            </div>
                        </div>
                ...
                <div className="lg:col-span-4 space-y-8">
                    ...
                    <div className="bg-gradient-to-br from-cyan-500 to-blue-600 rounded-[2.5rem] p-8 text-white shadow-xl shadow-cyan-500/20 relative overflow-hidden animate-slide-up transform transition hover:scale-[1.02]" style={{ animationDelay: '400ms' }}>
                        {/* Fluid Background */}
                        ...
                        <div className="relative z-10">
                            <div className="flex justify-between items-start mb-6">
                                <div>
                                    ...
                                    <p className="text-cyan-100 text-xs font-medium">Goal: 8 Cups</p>
                                </div>
                                <div className="p-2 bg-white/20 rounded-xl backdrop-blur-md">💧</div>
                            </div>
                    ...
                    <div className="bg-white rounded-[2rem] p-6 shadow-lg border border-slate-100 animate-slide-up" style={{ animationDelay: '500ms' }}>
                        <h3 className="text-sm font-bold text-slate-400 uppercase tracking-wider mb-4">How do you feel?</h3>
                    ...
                    {/* 🎟️ NEXT APPOINTMENT */}
                    <div className="group relative animate-slide-up" style={{ animationDelay: '600ms' }}>
                        <div className="relative bg-white rounded-[2rem] shadow-lg overflow-hidden border border-slate-100 hover:-translate-y-1 transition-transform duration-300">
                            ...
                            <div className="bg-slate-900 p-6 text-white relative">
                                ...
                                <div className="flex justify-between items-center mb-2">
                                    <span className="text-xs font-bold text-slate-400 uppercase tracking-widest">Next Visit</span>
                                    <span className="bg-slate-700 px-2 py-0.5 rounded text-[10px] font-bold uppercase text-white">Confirmed</span>
                                </div>
                                <h3 className="text-xl font-serif font-bold">Consultation</h3>
                                <p className="text-slate-400 text-sm">Dr. {nextAppt?.dietitian?.name || 'AyurCare'}</p>
                            </div>
                            ...
                            <div className="p-6 pt-8 bg-white">
                                {nextAppt ? (
                                    <div className="flex justify-between items-end">
                                        <div>
                                            <p className="text-4xl font-black text-slate-800 leading-none mb-1">{new Date(nextAppt.date).getDate()}</p>
                                            <p className="text-xs font-bold text-slate-400 uppercase">{new Date(nextAppt.date).toLocaleString('default', { month: 'long' })}</p>
                                        </div>
                                        <div className="text-right">
                                            <p className="text-lg font-bold text-indigo-600">{nextAppt.slotTime}</p>
                                        </div>
                                    </div>
                                ) : (
                                    <div className="text-center py-2">
                                        <Link to="/patient/book-appointment" className="text-indigo-600 text-sm font-bold hover:underline">Schedule Now &rarr;</Link>
                                    </div>
                                )}
                            </div>
                        </div>
            ...
            {/* --- STREAK MODAL (WORKING FUNCTIONALITY) --- */}
            {showStreakModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm animate-fade-in">
                    <div className="bg-white rounded-[2rem] shadow-2xl p-8 max-w-sm w-full relative overflow-hidden text-center">
                        ...
                        <h2 className="text-3xl font-black text-slate-800 mb-2">{streakData.count} Day Streak!</h2>
                        <p className="text-slate-500 mb-8">Consistency is the key to Ayurvedic balance. Keep it up!</p>
